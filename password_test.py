...
class TestPasswords(unittest.TestCase):
    ...
    def setUp(self):
        ...
        before every test
        '''
        self.new_password = Password('facebook', '1234')

    def test_init(self):
        '''
        this test checks whether the data entered into the properties if called will appear
        '''
    ...
    def test_save_multiple(self):
        ...
        '''
        self.new_password.save_page()
        test_pass = Password('instagram', '5432')
        test_pass.save_page()
    ...
    def test_find_page(self):
        ...
        '''
        self.new_password.save_page()
        test_pass = Password('instagram', '5432')  # new contact
        test_pass.save_page()
